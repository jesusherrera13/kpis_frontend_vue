...
const items = shallowRef([
    { tab: 'Perfil', icon: UserCircleIcon, href: '/apps/empresa/profile' },
    { tab: 'Historial', icon: HeartIcon, href: '/apps/empresa/profile/followers' },
    { tab: 'Viáticos', icon: UsersIcon, href: '/apps/empresa/profile/friends' },
    { tab: 'Empresa', icon: PhotoIcon, href: '/apps/empresa/profile/gallery' }
]);
            ...
            <v-row class="mt-1">
                ...
                <v-col cols="12" lg="4" sm="12" class="d-flex justify-center order-sml-first">
                    <div class="text-center top-spacer">
                        ...
                        <h5 class="text-h5 mt-3">{{ empresa?.razon_social }}</h5>
                        <span class="text-h6 font-weight-regular">{{ empresa?.nombre_comercial }}</span>
                    </div>
                </v-col>
