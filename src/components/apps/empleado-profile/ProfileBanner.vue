...
const items = shallowRef([
    { tab: 'Perfil', icon: UserCircleIcon, href: '/apps/empleado/profile' },
    { tab: 'Historial', icon: HeartIcon, href: '/apps/empleado/profile/followers' },
    { tab: 'Viáticos', icon: UsersIcon, href: '/apps/empleado/profile/friends' },
    { tab: 'Empresa', icon: PhotoIcon, href: '/apps/empleado/profile/gallery' }
]);

const props = defineProps({
    empleado: Object || Array
});
</script>
            ...
            <v-row class="mt-1">
                ...
                <v-col cols="12" lg="4" sm="12" class="d-flex justify-center order-sml-first">
                    <div class="text-center top-spacer">
                        ...
                        <h5 class="text-h5 mt-3">{{ empleado?.employee_name }}</h5>
                        <span class="text-h6 font-weight-regular">{{ empleado?.rol }}</span>
                    </div>
                </v-col>
