...
const items = shallowRef([
    ...
    { tab: 'Historial', icon: HeartIcon, href: '/apps/user/profile/followers' },
    { tab: 'Viáticos', icon: UsersIcon, href: '/apps/user/profile/friends' },
    { tab: 'Empresa', icon: PhotoIcon, href: '/apps/user/profile/gallery' }
]);
            ...
            <v-row class="mt-1">
                ...
                <v-col cols="12" lg="4" sm="12" class="d-flex justify-center order-sml-first">
                    <div class="text-center top-spacer">
                        ...
                        <span class="text-h6 font-weight-regular">{{ user?.rol }}</span>
                    </div>
                </v-col>
