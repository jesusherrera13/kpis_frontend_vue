...
const getData = computed(() => {
    ...
    return storeDashboard.acumulado_rubro.map((item: any) => {
        console.log(item);
...
<template>
    <VCard elevation="10">
        <v-card-text>
            <div>
                <h3 class="text-h5 title mb-1">Acumulado de Rubros</h3>
            ...
            <v-table class="month-table mt-7 mb-5">
                <template v-slot:default>
                    ...
                    <tbody>
                        <tr v-for="item in getData" :key="item.id" class="month-item">
                            <td>
                            ...
                            <td>
                                <h4 class="text-no-wrap text-body-1 text-right">
